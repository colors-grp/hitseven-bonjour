<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
			...
			<?php echo anchor('', lang('website_title'), 'class="brand" style = "font-weight: bold;"'); ?>
                ...
                <ul class="nav pull-right">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<?php if ($this->authentication->is_signed_in()) : ?>
							 <?php $header_pic = $account_details->picture . "/?type=square" ?>
                        	 <?php echo $account_details->firstname; ?> <img src = "<?=$header_pic; ?>" height = "30" width = "30" style = "border-radius:50%; margin-left: 10px;"/><b class="caret"></b></a>
						<?php else : ?>
                        ...
                        <ul class="dropdown-menu">
							<?php if ($this->authentication->is_signed_in()) : ?>
                                ...
                                <li><?php echo anchor('StarQuell_profile', 'StarQuell Profile'); ?></li>
							...
							<?php else : ?>
                                                                <li><?php echo $this->authentication->anchorToCore('sitecode='.  sitecode() .'&mode=signin', lang('website_sign_in'), array ('sitecode' => sitecode())); ?></li>
							<?php endif;  ?>
