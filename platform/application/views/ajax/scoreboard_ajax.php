...
<div id="ranks_table_div" >
                    ...
                    <table>
                            ...
                            <tr>
                                    <td rowspan = "2" style = "width: 190px; text-align: center;">
                                            <img src="<?=base_url()?>/h7-assets/resources/img/main-icons/<?=$top_users[($all_users[$i]['rank']-1)]['name'];?>_icon.png" alt="gold" style = "width:70px; margin-left: 26px;">
                    ...
                    <table>
                            ...
                            <tr>
                                    ...
                                    <td rowspan = "2" style = "width: 190px; text-align: center;">
                                            ...
                                            <img src="<?=base_url()?>/h7-assets/resources/img/main-icons/<?=$top_users[($all_users[$i]['rank']-1)]['name'];?>_icon.png" alt="silver" style = "width:70px; margin-right: 26px;">
                                    </td>
                            </tr>
                            <tr>
                                    <td class = "score-td" style = "padding-left: 10px;"><img src="<?=base_url();?>/h7-assets/resources/img/main-icons/score_icon2.png" alt="score-icon" ><?=$all_users[$i]['score'];?></td>
    ...
    <table id = "rank-table">
            ...
            for($i = (count( $top_users ) - $removedRanks); $i < count ( $all_users); $i ++) {
                            ...
                            <tr class = "<?=$class?>">
                                    <td class = "first-col"><?=$all_users[$i]['rank']?></td>
                                    <td><?=$all_users[$i]['user_name']?></td>
                                    <td><?=$all_users[$i]['score']?></td>
                                    <td><img src="<?=base_url()?>h7-assets/images/scoreboard/change/<?=$all_users[$i]['change']?>.png" alt="<?=$all_users[$i]['change']?>"></td>
                            </tr>
            <?php } } else {
                    echo 'No Users<br />';
            }?>
